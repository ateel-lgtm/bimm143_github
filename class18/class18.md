...
Pertussis (a.k.a whooping cough) is a common lung infectuion caused by
the bacteria B.Pertussis.

This infection can affect people all ages but is most severe for those
under 1 year of age.
...
> (1946), and the switch to the newer aP vacccine (1996).
...
The graph shows were high case numbers in the pre 1940s, they were
reduced drastically based on the rolling out of the wP vaccine. The
numbers then began to rise again in the 1980s due to the fact that
documentaries and studies came out that falsely linked other sicknesses
to vaccines. This lead to less vaccines being given and a rise in
infections. Another correlation that can be made from the graph below
and requires further research is the fact that the aP induced protection
wanes faster than wP but why? and does this cause the rise of infection
as well?
...
boost project aims to provide the scientific community with this very
information.
...
To analyze this data we need to first “join” (merge) the different
tables so we have all the data in one place not spread accross different
tables.
...
> Q. How many times do the datasets appear in the abdata? what do you
> notice from this?
...
were so many data sets in 2020 likely the result of the covid pandemic
while there was an extremely low amount in the 2021 and 2022 data sets
with an increase again in 2023. Although something to notice is tat even
in 2023 we dont have half of the entries that we did from 2020.
