...
The data for today’s mini-project comes from a knock-down experiment
study of an important HOX gene.
...
We need to remove funny “length” column from our `countData` to make the
columns match with the rows in the `colData`
...
```
    ...
    Info: Working in directory C:/Users/black/Documents/BIMM 143/bimm143_github/class14
...
```
    ...
    Info: Writing image file hsa04114.pathview.pdf
...
The cell cycle process mitotic, the cell cycle, and the checkpoints of
the cell cycle have the best p-values for significant entities. While
these matches don’t match with KEGG this is due to the fact that they
